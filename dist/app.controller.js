...
let AppController = class AppController {
    appService;
    groqService;
    constructor(appService, groqService) {
    ...
    async getGroqResponse(prompt) {
        return {
            response: await this.groqService.generateChatCompletion(prompt || 'Say hello to the chicken shop system.'),
        };
    }
};
...
__decorate([
    (0, common_1.Get)('ai/groq'),
    __param(0, (0, common_1.Query)('prompt')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "getGroqResponse", null);
